...
##con becomes contributions1 without summarize sum

#create list of pro.type and con.type
pro.type <- c()
con.type <- c()
i=1
while(i<8) {
...
cand <- candidates %>% ## New candidate dataset
...
election <- full_join(cand, contributions1, by = "cand_id") %>% 
