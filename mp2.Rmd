...
ggplot(election_total, aes(x = entity.type, y = amount/party_entity_total*100, fill=transaction.type)) + 
  geom_bar(stat = "identity") + 
  facet_wrap(~cand_party_affiliation) +
  labs(title = "Distribution of Contributions by Party and Entity Type",x="Entity Type", y="Percentage of Contributions") +
...
ggplot(election_non_org, aes(x = entity.type, y = party_entity_total, fill=transaction.type)) + 
  geom_bar(stat = "identity") + 
  facet_wrap(~cand_party_affiliation) +
...
ggplot(election_org_only, aes(x = entity.type, y = party_entity_total, fill=transaction.type)) + 
  geom_bar(stat = "identity") + 
  facet_wrap(~cand_party_affiliation) +
  labs(title = "Distribution of Contributions by Party and Entity Type (ORG)",x="ORG", y="Amount of Contributions") +
  theme(plot.title=element_text(size=rel(1), 
                                face="bold", 
                                family="Helvetica", 
                                hjust=0.5), 
